    ...
    return (
        <div className="mb-4 p-4 bg-white rounded-lg shadow-sm">
            ...
            {((comment?.images?.length > 0) || (comment?.videos?.length > 0)) && (
                <div className="flex gap-3 overflow-x-auto scrollbar-thin scrollbar-thumb-pink-200 scrollbar-track-transparent mt-4 pb-2 snap-x snap-mandatory">
            ...
            <div className="border-l-2 border-pink-200 ml-4 pl-2">
                {
